...
void simulation::initGUIElements()
{
    ...
    parameterBar = inputHandler::createNewBar("Parameters","position='8 8' size='400 1000'");
    activationBar = inputHandler::createNewBar("Activation","position='408 8' size='400 800'");
    general = inputHandler::createNewBar("General","position='808 8' size='400 260'"); 
